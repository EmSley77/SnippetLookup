                ...
                <div className="bg-gray-900 text-white min-h-screen  flex justify-center items-center">
                    <div>
                        ...
                        <div className="flex justify-center items-center">
                            <div>
                                <button onClick={handleGoogleLogin} className="cursor-pointer flex items-center justify-center py-2 px-20 bg-white hover:bg-gray-400 focus:ring-blue-500 focus:ring-offset-blue-200 text-gray-700 w-full transition ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2 rounded-lg">
                                ...
                                <button className="cursor-pointer flex items-center justify-center py-2 px-20 bg-white hover:bg-gray-400 focus:ring-blue-500 focus:ring-offset-blue-200 text-gray-700 w-full transition ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2 rounded-lg mt-4">
