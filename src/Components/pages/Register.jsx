            ...
            <div className="flex justify-center items-center w-full h-screen bg-gray-100">
                <div className="bg-white shadow-lg rounded-lg p-8 w-full max-w-md">
                    ...
                    <form onSubmit={handleRegisterSubmit} autoComplete="off" className="space-y-4">
                        ...
                        <div>
                            <label className="text-sm text-gray-600" htmlFor="username">Username</label>
                            <input
                                id="username"
                        ...
                        <div>
                            <label className="text-sm text-gray-600" htmlFor="repassword">Confirm Password</label>
                            <input
                                id="repassword"
                        ...
                        <div>
                            <label className="text-sm text-gray-600" htmlFor="language">Preferred Language</label>
                            <select
                                id="language"
                                className={inputClass}
                        ...
                        {message && <h1 className="text-green-500 text-center text-lg">{message}</h1>}
                        <button
                            type="submit"
...
const inputClass = "w-full px-3 py-2 mt-1 bg-gray-200 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-gray-800";